...
# python testbase.py --model deit_base_patch16_224 --datatrain_path ../TinyImageNet/tiny-imagenet-200 --dataval_path ../TinyImageNet/tiny-imagenet-200 --batch_size 64 --neuron_pruning --head_pruning --seed 2025 --idx 0
def get_args_parser():
...
def main(args):  
    ...
    set_seed(args.seed)
    idx = args.idx
    sys.stdout = open('Base'+str(idx)+'.txt', 'w')
    ...
    # 加载预训练模型
    model.load_state_dict(torch.load("../logs/deit_base.pth"))
